            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    if (ten.isEmpty() || mk.isEmpty()) {
                        CheckConnection.ShowToast(getApplicationContext(), "Vui lòng nhập đầy đủ thông tin");
                        check = true;
                ...
                if (check == false){
                    CheckConnection.ShowToast(getApplicationContext(), "Thông tin không chính xác");
                }
            }
        });
    }

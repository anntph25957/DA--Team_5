...
public class DoAnFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AnhXa(view);
        if (CheckConnection.HaveConnection(getActivity())){
            GetData(page);
            LoadMoreData();
        }else{
            CheckConnection.ShowToast(getActivity(), "Không có kết nối mạng");
        }
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, link, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2){
                    ...
                    limitData = true;
                    lvDs.removeFooterView(footerView);
                    CheckConnection.ShowToast(getActivity(), "Hết dữ liệu");
                }
            }

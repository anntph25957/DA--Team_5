...
public class TenSpDonHangAdapter extends RecyclerView.Adapter<TenSpDonHangAdapter.BauHolder> {
    private Context context;
    private ArrayList<GioHang> listDonHang;

    public TenSpDonHangAdapter(Context context, ArrayList<GioHang> listDonHang) {
    ...
    public BauHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_ten_sp_chit_tiet_don_hang, parent, false);
